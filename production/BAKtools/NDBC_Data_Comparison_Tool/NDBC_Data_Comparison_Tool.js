...
(function (eduVis) {
    ...
    var tool = {
        ...
        "data" : {},
        "target_div" : "NDBC_Data_Comparator",
        "tools" : {}

    };

    tool.NDBC_Data_Comparator = function( _target_div ){
    ...
    tool.init = function() {
        ...
        console.log("init at " + this.target_div);
        this.NDBC_Data_Comparator(this.target_div);
