...
*/
    _tool_listing = function(_target_div){
        ...
        var domTarget = (typeof _target_div !== "undefined" && _target_div !== "") ? "body" : "#" + _target_div; 
        
        alert(domTarget);

        $.getJSON('tools.json', function(tools) {

            console.log("TOOLS --->", tools)

            var toolListing = $("<div></div>");
                ...
                .append(
                    $("<div></div>")
                        .append(
                            $("<h1></h1>")
                                .html(tools.name)
                                .attr("title", "Tools as of " + tools.date)
                                .append(
            ...
            toolListing.appendTo(domTarget);
