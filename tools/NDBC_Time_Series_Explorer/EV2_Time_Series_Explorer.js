/*
    ...
    Name: EV2 Time Series Explorer
    Description: 
    Version: 0.1.0
    Revision Date: 2/22/2013
    Author: Michael Mills
    Author URL: http://marine.rutgers.edu/~mmills/
    Function Name: EV2_Time_Series_Explorer
    Help File: 

*/

var EV2_Time_Series_Explorer_Dependencies =
    {
        ...
        "stylesheets":[
            ...
            },
            {
                ...
                "src":"EV2_Time_Series_Explorer/EV2_Time_Series_Explorer.css"
            },
...
var EV2_Time_Series_Explorer = function ( domID, customToolConfiguration ) {
    ...
    self.parameters = self.sos.getObservationObj(
        [
